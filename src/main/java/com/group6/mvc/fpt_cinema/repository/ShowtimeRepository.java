...
public interface ShowtimeRepository extends JpaRepository<Showtime, Integer> {
    ...
    boolean existsByRoomIdAndStatus(Integer roomId, ShowtimeStatus status);
    boolean existsByRoomIdAndStatusNotInAndStartTimeAfter(Integer roomId, List<ShowtimeStatus> statuses, LocalDateTime startTime);

    List<Showtime> findByRoomIdAndStatusNotIn(Integer roomId, List<ShowtimeStatus> statuses);

    List<Showtime> findByMovieIdAndStatusNotInOrderByStartTimeAsc(Integer movieId, List<ShowtimeStatus> statuses);

    List<Showtime> findByStatusNotInOrderByStartTimeAsc(List<ShowtimeStatus> statuses);
