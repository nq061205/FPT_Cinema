...
import com.group6.mvc.fpt_cinema.dto.request.RoomStatusRequest;
...
public class RoomController {
    ...
    @GetMapping
    public ApiResponse<Page<RoomResponse>> getAllRoms(
        ...
        .result(roomService.getAllRooms(status, roomType, pageable))
        .build();
    }
